package com.HUEdge.NetflixApp.entities;
...
@Entity
@Table(name="netflix_data" ,schema="netflix_schema")
public class NetflixData {
	...
	public NetflixData(String showId, String showType, String title, String director, String cast, String country,
